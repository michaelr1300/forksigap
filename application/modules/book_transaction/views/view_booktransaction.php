...
<header class="page-title-bar mb-3">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a href="<?= base_url('book_transaction'); ?>">Stok Buku</a>
            </li>
            <li class="breadcrumb-item">
                <a class="text-muted">
                    <?= $input->book_title; ?>
    ...
    <section id="data-draft" class="card">
        <header class="card-header">
            <ul class="nav nav-tabs card-header-tabs">
                ...
                <li class="nav-item ">
                    <a class="nav-link active show" data-toggle="tab" href="#transaction-data"><i
        ...
        <div class="card-body">
            <div class="tab-content">
                <!--transaction data-->
                <div class="tab-pane fade active show" id="transaction-data">
                    <div id="reload-transaction">
                        ...
                        <?php //if (empty($transaction_history) == FALSE) : ?>
                        <hr>
                        <!-- Log Perubahan Stok -->
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            <button title="Delete" type="button" class="btn btn-sm btn-danger"
                                                data-toggle="modal"
                                                data-target="#modal_delete_transaction<?//= $history->book_transaction_id; ?>">
                                                <i class="fa fa-trash-alt"></i>
                                                <span class="sr-only">Delete</span>
                                            </button>
                                            <!-- Modal Hapus -->
                                            <div class="modal modal-alert fade"
                                                id="modal_delete_transaction<?//= $history->book_transaction_id; ?>" tabindex="-1"
                                                role="dialog"
                                                aria-labelledby="modal_delete_transaction<?//= $history->book_transaction_id; ?>"
                                                aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="<?//= base_url('book/delete_book_transaction/' . $history->book_transaction_id); ?>"
